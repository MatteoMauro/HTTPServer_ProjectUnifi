 ...
 */
public class HEAD_HTTPHandler1_1Test {
	...
	/**
	 * Test if HEAD_HTTPHandler1_1 can retrieve correctly the files in this
	 * case: 1) host and root not specified (default -> host = null,
	 * root="/www"); 2) correct host specified; 3) root specified.
	 */
	@Test
	public void validRequest() {
		HEAD_HTTPHandler1_1 handlerDefault = setupHandler(null, null);
		HEAD_HTTPHandler1_1 handlerSpecifiedHost = setupHandler(validHost, null);
		HEAD_HTTPHandler1_1 handlerSpecifiedRoot = setupHandler(null, validRoot);
		HTTPRequest request = setupHTTPRequest(methodSamples + "head11.txt");
		// default
	...
	/**
	 * Test if HEAD_HTTPHandler1_1 returns 404 if file is not found.
	 */
	@Test
	public void fileNotFound404() {
		HEAD_HTTPHandler1_1 handlerDefault = setupHandler(null, null);
		HTTPRequest request = setupHTTPRequest(methodSamples + "head11FileNotFound.txt");
		HTTPReply reply = handlerDefault.handle(request);
	...
	public void hostNotCompatible() {
		...
		HEAD_HTTPHandler1_1 handler = setupHandler(validHost, null);
		HTTPRequest request = setupHTTPRequest(methodSamples + "head11WrongHost.txt");
	...
	public void methodNotCompatible() {
		HEAD_HTTPHandler1_1 handler = setupHandler(null, null);
	...
	private HEAD_HTTPHandler1_1 setupHandler(String host, File root) {
		return new HEAD_HTTPHandler1_1(host, root);
	}
