 ...
 *
 */
public class POST_HTTPHandler1_0 extends HTTPHandler1_0 {

	private final String method = "POST";

	public POST_HTTPHandler1_0(File root) {
		super(root);

	}

	public POST_HTTPHandler1_0(String host, File root) {
		super(host, root);
	}
	...
	/**
	 * Gets the path of the file and if it exists, it prints the body of the
	 * request which should contain some data. It sends 404 if the file does not
	 * exist.
	 */
	@Override
